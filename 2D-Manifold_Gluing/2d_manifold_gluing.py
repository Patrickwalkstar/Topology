...
def euler_characteristic(verteces, number_of_edges):
    ...
    return len(verteces)-number_of_edges+1
...
def determine_genus(Euler,orientable,compacted_boundaries):
    if orientable: genus=0-((Euler+compacted_boundaries-2)/2) # if the surface is orientable, this equation allows you to calculate the genus
    else: genus=0-(Euler+compacted_boundaries-2) #if the surface is not orientable, this equation allows you to calculate the genus
    return (genus)

genus=determine_genus(Euler,orientable,compacted_boundaries)

print(f'The Euler characteristic is {str(Euler)}')
print(f'There are {str(compacted_boundaries)} boundaries')
if not orientable: print('The surface is not orientable')
else: print('The surface is orientable')
print (f'The genus of the surface is {str(genus)}')